            ...
            <div class="box round first grid">
                ...
                <?php 
                    if($_SERVER['REQUEST_METHOD']=='POST'){
                     ...
                     if($fb =="" || $tw =="" || $ln =="" || $gp ==""){
                       echo "<span class='error'>Social_media field must not be empty</span>";
                       }
                     else{ 
                        ...
                        if($SOCIAL){
                            echo "<span class='success'> Social media Updated succesfully</span>";
                        }else{
                            echo "<span class='error'>error.. Social media Update failed</span>";
                        }       
                       }
                     } 
                 ?>    
